%%%  Vzorový text a dokumentace stylu pro text závěrečné práce na KI
%%%  PřF UP v Olomouci
...
%%  Třída dokumentu pro závěrečnou práci. Vybrané nepovinné parametry
%%  (ostatní v dokumentaci):
...
%%  odkazy s uvedením URL za odkazem, ne odkazy do rejstříku), jinak
%%  verze pro prohlížeč
...
%%  jinak je výchozí czech pro český
...
%% Informace pro úvodní strany. Česky a anglicky. Uveďte všechny, u
%% kterých není v komentáři uvedeno, že jsou volitelné. Při neuvedení
%% se použijí výchozí texty. Text pro jiný než nastavený jazyk
%% dokumentu (nepovinným parametrem language makra \documentclass,
%% výchozí český) se zadává použitím makra s uvedením jazyka jako
%% nepovinného parametru.

%% Název práce, včetně anglického. Měl by se vysázet na jeden řádek.
\title{Styl pro text závěrečné práce}
\title[english]{A style for graduation thesis}

%% Volitelný podnázev práce, včetně anglického. Měl by se vysázet na
%% jeden řádek. Výchozí je prázdný.
\subtitle{Vzorový text a dokumentace stylu v \LaTeX{}u}
...
%% Anotace práce, včetně anglické (obvykle překlad české). Jeden
%% odstavec!
\annotation{Vzorový text závěrečné práce na Katedře informatiky
...
\annotation[english]{Sample text of graduation thesis at the
  \uptextdepten, \uptextfacultyen, \uptextuniven{} and, at the same
  time, documentation of the \LaTeX{} style for the text. The source
  text in \LaTeX{} is recommended to be used as a template for real
  student's graduation thesis text.}

%% Klíčová slova práce, včetně anglických. Oddělená (obvykle) středníkem.
\keywords{styl textu; závěrečná práce; dokumentace; vzorový text}
\keywords[english]{text style; graduation thesis; documentation; sample text}
...
%% Volitelné poděkování. Stručné! Výchozí je prázdný. Makro nemá
%% nepovinný parametr pro uvedení jazyka.
\thanks{Děkuji, děkuji, děkuji.}

%% Soubor s bibliografií pro její sazbu pomocí BibLaTeXu (zvolenou
%% nepovinným parametrem biblatex makra \documentclass). Použijte
%% pouze při této sazbě, ne při (výchozí) sazbě v prostředí
%% thebibliography.
\bibliography{bibliografie.bib}

%% Další balíky potřebné pro sazbu vlastního textu práce.
\usepackage{lipsum}
...
%% použijte prostředí upconclusions. Povinná je i příloha s obsahem
%% přiloženého CD/DVD.
...
Pro sazbu literatury má uživatel dvě možnosti. Může použít služeb balíků \BibLaTeX{}, který je pro \textbf{upstyles} zapnutý, či lze použít manuální sazbu bibliografie.
...
Dokument, který využívá \BibLaTeX{} je následně nutné přeložit jak pomocí překladače zvoleného ovladače, tak pomocí aplikace \upinlinecode{text}{!}{biber}. Více informací poskytne soubor \upinlinecode{text}{!}{Makefile} z distribuce tohoto stylu.
...
\newacronym{UPOL}{UPOL}{\uptextunivcz}
...
%% Závěry práce. Česky a anglicky. Text pro jiný než nastavený jazyk
%% dokumentu (nepovinným parametrem language makra \documentclass,
%% výchozí český) se zadává použitím makra s uvedením jazyka jako
%% nepovinného parametru.
\begin{upconclusions}
...
%% práce!
\section{Obsah přiloženého CD/DVD} \label{ObsahCD}
