...
\yearofsubmit{\the\year}			        % Rok odevzdání.
...
\annotation[english]{This document is good. This document is
  ...
  good. This document is good. This document is good.}
...
\item Použítím maker \upinlinecode{TeX}{!}{\\upindex} či \upinlinecode{TeX}{!}{\\index} rejstříkovat vybrané pojmy.
...
Makro \upinlinecode{TeX}{!}{\\upindex} používejte v případě, že chcete klikací odkaz na rejstříkovaný výraz. Jediným argumentem výrazu je právě ten výraz. Výsledek vypadá takto\upindex{výsledek rejstříkování}.

\textbf{Makro \upinlinecode{TeX}{!}{\\upindex} má jedno kritické omezení. Nelze jej používat v případě, že chcete přes cílový záznam referencovat, například volání \upinlinecode{TeX}{!}{\\upindex\{záznam|see \{hello\}\}} není možné.}

Makro \upinlinecode{TeX}{!}{\\index} zůstává od původní funkčnosti nezměněno.
