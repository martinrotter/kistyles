...
Makro \upinlinecode{TeX}{!}{\\index} používejte v případě, že chcete klikací odkaz na rejstříkovaný výraz. Jediným argumentem výrazu je právě ten výraz. Výsledek vypadá takto\index{výsledek rejstříkování}.

\textbf{Makro \upinlinecode{TeX}{!}{\\index} má jedno kritické omezení. Nelze jej používat v případě, že chcete přes cílový záznam referencovat, například volání \upinlinecode{TeX}{!}{\\index\{záznam|textit\}} není možné. Pokud chcete použít toto chování, pak je třeba Vaše cílové makro (v tomto případě makro \upinlinecode{TeX}{!}{\\textit} obalit }
