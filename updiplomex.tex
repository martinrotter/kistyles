...
V současné době byla zahozena podpora pro \keyword{latex} a \keyword{cslatex}. Je tedy používán výlučně \keyword{PDF} ovladač skrze program \keyword{pdflatex}. Toto použití má hned několik důvodů:
\begin{itemize}
