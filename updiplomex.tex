...
%% Deklarace zkratky
\upabbrevdeclare{UPOL}{Univerzita Palackého v Olomouci}
...
\upabbrevdeclare{ZKRATKA}{TEXT ZKRATKY}
\end{upcode}
Odkazovat se na zkratky lze použitím makra \verb|\upabbrevref{ZKRATKA}|. Pokud například máme definovanou zkratku UPOL, tak se na ní můžeme odkázat několikrát, třeba dvakrát, za sebou. Tedy \upabbrevref{UPOL} a ještě jednou \upabbrevref{UPOL}.
